...
public class CmdF10 extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        if (args.length == 0) {
            sender.addChatMessage(new ChatComponentText("§cUsage: /setf10 [message]"));
            return;
        }
